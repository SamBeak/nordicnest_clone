        ...
        <div className="container">
            ...
            <div className="tap-inner__container">
                ...
                <div className="tap-inner__text">
                    ...
                    <p>
                        <p>- 상품의 출고일은 상품의 준비 상태 및 재고 상태에 따라 달라집니다.</p>
                        <p>- 상품의 재고가 있는 경우 출고 준비를 위해 보통 1-2 영업일이 소요됩니다.</p>
                        <p>- 상품의 재고가 없는 경우에는 통상적으로 9 영업일 이상 소요되며, 공급사의 스케쥴 마다 달라집니다. 대략적인 재입고 예정일은 상품 구매 페이지에서 확인하실 수 있습니다.</p>
                    </p>
                </div>
                <div className="tap-inner__text">
                    <p><strong>출고 후 배송완료까지 걸리는 기간</strong></p>
                    <p>
                        <p>주문 시 선택하신 배송옵션 마다 소요되는 기간이 다릅니다. 배송옵션별 기간은 아래 정보를 참고해주세요.</p>
                    </p>
                </div>
                <div className="tap-inner__text">
                    <p><b>배송옵션</b></p>
